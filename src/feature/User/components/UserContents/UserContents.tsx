import { UserContentsProps } from '../../../../types';

import { StyledUserContent, StyledUserContents } from './UserContents.style';

interface Props {
  userContents: UserContentsProps;
}

export default function UserContents({ userContents }: Props) {
  const { blog, email, company } = userContents;
  return (
    <StyledUserContents>
      <StyledUserContent>
        {blog && (
